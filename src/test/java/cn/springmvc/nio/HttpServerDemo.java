 ...
 * Description This is a demo of Http Server.
 */
        ...
        public void handleRead(SelectionKey key) throws IOException{
            ...
            if (sc.read(buffer) == -1){
                ...
                sb.append("HTTP/1.1 200 OK\r\n")
                        .append("Content-Type:text/html;charset=" + localCharset + "\r\n")
                        .append("\r\n");
                sb.append("<html><head><title>显示报文</title></head>")
                        .append("</body>")
                        .append("服务器端获得的请求数据如下：<br/>");
                for (String str : requestMessage) {
                    sb.append(str + "<br/>");
                }
                sb.append("</body></html>");
